    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.go_second).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                User user = new User(22, "jake", true);
                User user1 = new User(233, "jake33", false);
                user.book = new Book(1,"testbook");
                //最终都会放在bundle,第三个Bundle也会放在intent中的Bundle里面，作为一个成员
                intent.putExtra("extra_user", (Parcelable) user);
                intent.putExtra("extra_user1", (Parcelable) user1);
                intent.putExtra("ad",new Bundle());
