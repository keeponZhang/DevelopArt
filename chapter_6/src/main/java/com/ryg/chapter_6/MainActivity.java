...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvShape = (TextView) findViewById(R.id.test_shape);
        Drawable drawable = textView.getBackground();
        Log.e(TAG, "bg:" + drawable + "w:" + drawable.getIntrinsicWidth()
                + " h:" + drawable.getIntrinsicHeight());
        Drawable background = tvShape.getBackground();
        Log.e("TAG", "MainActivity onCreate:" +background.getIntrinsicHeight());
    }
